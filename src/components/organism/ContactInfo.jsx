    ...
    <div className="flex flex-col xl:flex-row gap-9 p-6">
      <div className="flex-1 mb-7">
        <div className="flex flex-col gap-6 w-full mb-7">
          <div data-aos="fade-down" data-aos-duration="1500" className="flex gap-3 items-center text-amber-400">
            <PiStarFourFill />
            <p>CONTACT INFO</p>
          </div>
          <h1 data-aos="zoom-out" data-aos-duration="1500" className="text-5xl font-black "><span className="text-base-color">Connecting</span> Near & Far</h1>
          <p data-aos="fade-up" data-aos-duration="1500" className="text-gray-500">
