...
const PageHeader = ({ title, breadcrumbText, bgClass, overlayColor, titleColor, breadcrumbColor, arrowColor, customTitleClasses }) => {
  return (
    <div className={`h-[400px] bg-cover bg-center ${bgClass} relative flex flex-col justify-center items-center gap-6 mb-20`}>
      ...
      <div data-aos="fade-up" data-aos-duration="1500" className="flex z-10 mt-2" aria-label="Breadcrumb">
        <ul className="flex items-center space-x-2">
          <li className="inline-flex items-center">
            <Link to="/" className={`flex gap-2 items-center font-medium ${breadcrumbColor} hover:text-sky-700 transition-all duration-300`}>
              <FaHome />
              Home
            </Link>
          </li>
