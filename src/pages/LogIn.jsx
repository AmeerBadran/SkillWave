...
export default function LogIn() {
  return (
    <div className="grid grid-cols-1 2md:grid-cols-2 min-h-screen">
      {/* Left Section */}
      <div className="bg-login-bg bg-no-repeat bg-center flex flex-col justify-center items-center text-center px-8 bg-violet-200">
        <img src={loginImg} alt="Login" className="w-10/12 xl:w-8/12" />
        <h1 className="text-3xl font-semibold mt-8">Welcome to SkillWave Courses.</h1>
        <p className="text-center mt-4 text-gray-600 w-10/12">
          Welcome back! Log in to access your personalized dashboard and continue your learning journey with our exclusive courses. Unlock new skills and knowledge today!
        </p>
